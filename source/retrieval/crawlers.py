...
def get_paper_list_by_keywork(keyword, start_year = None, end_year = None, max_capacity = 100, debug_mode = False, retry_times = 3):
...
if __name__ == "__main__":
    get_paper_list_by_keywork(" bert ", start_year=2020, max_capacity=20, debug_mode=False, save_file = "paper_list.xlsx")
    print("end")
